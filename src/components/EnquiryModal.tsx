...
export const EnquiryModal: React.FC<EnquiryModalProps> = ({ isOpen, onClose, productName }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto bg-[#0B1F35] border border-white/20 rounded-3xl shadow-2xl text-white">
        
        {/* Modal Header */}
        <div className="sticky top-0 z-10 px-6 py-4 bg-[#061322] border-b border-white/10 flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-[#00B8D9]">
        ...
        <div className="p-6">
          {submitted ? (
            <div className="py-10 text-center space-y-3">
              <CheckCircle2 className="w-16 h-16 text-[#00B8D9] mx-auto animate-bounce" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <User className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                <input
                  type="text"
                  required
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/5 border border-white/15 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-[#00B8D9] transition-colors"
                />
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="relative">
                  <Mail className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                  <input
                    type="email"
                    required
                ...
                <div className="relative">
                  <Phone className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                  <input
                    type="tel"
                    required
                    maxLength={10}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="relative">
                  <MapPin className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                  <input
                    type="text"
                    required
                ...
                <div className="relative">
                  <Package className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                  <input
                    type="text"
              ...
              <div className="relative">
                <MessageSquare className="w-4 h-4 text-[#00B8D9] absolute left-3.5 top-3.5" />
                <textarea
                  required
                  rows={3}
