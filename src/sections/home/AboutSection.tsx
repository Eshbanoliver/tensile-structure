        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B1F35]/70 to-transparent" />
            </div>

            <div className="absolute -bottom-6 -right-4 sm:right-6 bg-[#0B1F35] text-white p-6 rounded-2xl shadow-2xl border border-white/20 backdrop-blur-xl max-w-[200px] text-center">
              <div className="font-poppins font-black text-4xl text-[#FFB703]">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-medium text-gray-700">
              <li className="flex items-start space-x-2">
                <CheckCircle className="w-4 h-4 text-[#00B8D9] flex-shrink-0 mt-0.5" />
            ...
            <div className="pt-4">
              <Link
                to="/about-us.htm"
                className="inline-flex items-center space-x-2 px-7 py-3.5 rounded-xl bg-[#0B1F35] hover:bg-[#123B63] text-white font-poppins font-bold text-xs uppercase tracking-wider shadow-xl border border-white/10 hover:scale-105 transition-all duration-300"
              >
